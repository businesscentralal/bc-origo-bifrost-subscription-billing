...
/// <summary>
/// Registers the Subscription Billing message types on the Cloud Events message type enum.
...
/// </summary>
enumextension 10035035 "CE Sub Msg Type ori" extends "Cloud Event Message Type ori"
{
    ...
    value(10035036; "Subscription.Line.Create")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Line Create Impl ori";
    }
    ...
    value(10035037; "Subscription.Contract.GetLines")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Con GetLines Impl ori";
    }
    ...
    value(10035038; "Subscription.Contract.CreateInvoice")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Con CrInvoice Impl ori";
    }
    ...
    value(10035039; "Subscription.Contract.PreviewInvoice")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Con PrvInvoice Impl ori";
    }
    ...
    value(10035040; "Subscription.Contract.UpdateLineDates")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Con UpdDates Impl ori";
    }
    ...
    value(10035041; "Subscription.Contract.UpdateExchangeRates")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Con UpdFCY Impl ori";
    }
    ...
    value(10035042; "Subscription.VendorContract.GetLines")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Vend GetLines Impl ori";
    }
    ...
    value(10035043; "Subscription.VendorContract.CreateInvoice")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Vend CrInvoice Impl ori";
    }
    ...
    value(10035044; "Subscription.VendorContract.PreviewInvoice")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Vend PrvInv Impl ori";
    }
    ...
    value(10035045; "Subscription.Billing.CreateProposal")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Bil CrProposal Impl ori";
    }
    ...
    value(10035046; "Subscription.Billing.CreateDocuments")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Bil CrDocs Impl ori";
    }
    ...
    value(10035047; "Subscription.Billing.PreviewDocuments")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Bil PrvDocs Impl ori";
    }
    ...
    value(10035048; "Subscription.PriceUpdate.SetTemplateFilter")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub PU SetFilter Impl ori";
    }
    ...
    value(10035049; "Subscription.PriceUpdate.CreateProposal")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub PU CrProposal Impl ori";
    }
    ...
    value(10035050; "Subscription.PriceUpdate.Perform")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub PU Perform Impl ori";
    }
    ...
    value(10035051; "Subscription.Renewal.Extend")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Ren Extend Impl ori";
    }
    ...
    value(10035052; "Subscription.Renewal.CreateQuote")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Ren CrQuote Impl ori";
    }
    ...
    value(10035053; "Subscription.Usage.ImportData")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Usg Import Impl ori";
    }
    ...
    value(10035054; "Subscription.Usage.Process")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Usg Process Impl ori";
    }
    ...
    value(10035055; "Subscription.Deferral.Release")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Def Release Impl ori";
    }
    ...
    value(10035056; "Subscription.Analysis.Recalculate")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Ana Recalc Impl ori";
    }
    ...
    value(10035057; "Subscription.Import.CreateContracts")
    {
        ...
        Implementation = "Cloud Event Msg Interface ori" = "CE Sub Imp CrContr Impl ori";
    }
}
