...
/// </summary>
codeunit 10035058 "Sub Helper ori"
{
    Access = Internal;
    ...
    procedure GetSubjectOr(var Argument: Record "Message Argument ori"; RequestJson: JsonObject; PropertyName: Text; Required: Boolean) Value: Code[20]
    begin
    ...
    procedure RespondWithSuccess(var Argument: Record "Message Argument ori"; var ResponseJson: JsonObject)
    var
