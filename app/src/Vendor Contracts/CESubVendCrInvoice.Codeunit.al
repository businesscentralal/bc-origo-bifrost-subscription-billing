...
codeunit 10035043 "CE Sub Vend CrInvoice Impl ori" implements "Cloud Event Msg Interface ori"
{
    ...
    begin
        ...
        CreateVendorInvoice(ContractNo, BillingDate, BillingToDate, DocumentDate, PostingDate, VendorInvoiceNo, BillingLineCount, DocumentsArray);
    ...
    /// </summary>
    internal procedure CreateVendorInvoice(ContractNo: Code[20]; BillingDate: Date; BillingToDate: Date; DocumentDate: Date; PostingDate: Date; VendorInvoiceNo: Text[35]; var BillingLineCount: Integer; var DocumentsArray: JsonArray)
    var
        ...
        if BillingLine.FindSet() then
            repeat
                if not DocumentNos.Contains(BillingLine."Document No.") then begin
                    ...
                    DocumentTypes.Add(Format(BillingLine."Document Type"));
                end;
